...
about_div <-
  column(
    width = 4, class = "col-md-4 col-lg-3 col-xl-3",
    tags$div(
      class = "ui card", style = "margin-top: 0; padding: 0px; width: 100%;",
      tags$div(
        class = "content",
...
chart_div <-
  column(
    width = 4, class = "col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-5 col-xl-4 col-xl-offset-5",
    tags$div(
      class = "ui card", style = "margin-top: 0; padding: 0px; width: 100%;",
      tags$div(
        class = "content",
...
footer_logos <- tags$div(
  ...
  splitLayout(
    cellWidths = c("20%", "80%"),
    tags$a(
      href = "https://www.udel.edu/academics/colleges/canr/departments/animal-and-food-sciences/affiliated-centers/cewer/",
      target = "_blank",
      tags$img(src = "ud_logo.png", height = "100%", width = "20em")
    ),
    tags$a(
      href = "https://techimpact.org/", target = "_blank",
...
used to help predict the magnitude, direction and extent of the pandemic."),
  ...
  column(
    ...
    tags$div(
      ...
      tags$p(
        tags$a(href = "https://www.nccde.org/", target = "_blank", "New Castle County Homepage"),
        tags$br(),
      ...
      tags$h5("CompassRed"),
      tags$p(
        tags$a(href = "https://www.compassred.com", target = "_blank", "CompassRed Homepage"), tags$br(),
        tags$a(
          href = "https://www.github.com/CompassRed/ncco_wastewater_dash/",
